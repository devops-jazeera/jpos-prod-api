...
cron.schedule('*/15 * * * *', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                Log_1.hlog.info("**************************Checking internet cron ****************************");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 2:
                ...
                if (!internet) {
                    restart = true;
                    Log_1.hlog.info("**************************NO INTERNET TRYING TO RESTART SERVICE *******************");
                }
                else {
                    if (internet && restart) {
                        restart = false;
                        Log_1.hlog.info("**************************INTERNET CAME SERVICE RESTARTING PLEASE WAIT ......................... *******************");
                        SysService_1.SysService.ResetService(Log_1.hlog);
                    }
                }
                return [3 /*break*/, 4];
