...
var SyncPrevTransactionsService = /** @class */ (function () {
    function SyncPrevTransactionsService() {
        ...
        // this.localDbPool = (PoolConnectionConfig.LocalPool;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, SyncServiceHelper_1.SyncServiceHelper.BatchQueryunPool(this.localDbPool, queryData, Log_1.log)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, SyncServiceHelper_1.SyncServiceHelper.ExecuteQuery(this_1.localDbPool, MultiLineDiscRangesQuery, Log_1.log)];
                                    case 1:
                                    ...
                                    case 2:
                                        ...
                                        return [4 /*yield*/, SyncServiceHelper_1.SyncServiceHelper.ExecuteQuery(this_1.localDbPool, InstantDiscRangesQuery, Log_1.log)];
                                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, SyncServiceHelper_1.SyncServiceHelper.ExecuteQuery(this.localDbPool, text, Log_1.log)];
                    case 2:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, SyncServiceHelper_1.SyncServiceHelper.ExecuteQuery(this.localDbPool, saleslinequery, Log_1.log)];
                    case 6:
