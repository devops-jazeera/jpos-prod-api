...
var WorkflowService = /** @class */ (function () {
    ...
    WorkflowService.prototype.save = function (item, type) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var queryRunner, unSyncedData, status_1, info, promistList, usergroupid, inventlocationid, selectedLinesData, condition, salesData, _a, RM_AND_RA, canSendForApproval, date, inventtransQuery, canSendForApproval, date, inventtransQuery, selectedLines, cond, salestableData, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!(item.id || item.orderId)) return [3 /*break*/, 42];
                    ...
                    case 10:
                        RM_AND_RA = _b.sent();
                        if (!(type == "sendforapproval")) return [3 /*break*/, 31];
                    ...
                    case 22:
                        if (!(salesData.transkind == "DESIGNERSERVICERETURN")) return [3 /*break*/, 23];
                        ...
                        return [3 /*break*/, 29];
                    case 23: return [4 /*yield*/, this.stockOnHandCheck(salesData)];
                    case 24:
                        canSendForApproval = _b.sent();
                        if (!canSendForApproval) return [3 /*break*/, 28];
                        item.statusId = "PENDINGRMAPPROVAL";
                        if (!(RM_AND_RA.rm && RM_AND_RA.rm != "")) return [3 /*break*/, 26];
                        item.pendingWith = RM_AND_RA.rm;
                        date = new Date().toISOString();
                        inventtransQuery = " UPDATE inventtrans SET transactionclosed = " + true + ", reserve_status = 'RESERVED'  ";
                        if (date) {
                    ...
                    case 25:
                        _b.sent();
                        return [3 /*break*/, 27];
                    case 26: throw { status: 0, message: "NO_RM_ADDED_TO_YOUR_GROUP_PLEASE_CONTACT_SYSTEM_ADMIN" };
                    case 27: return [3 /*break*/, 29];
                    case 28: throw { status: 0, message: "SOME_OF_THE_ITEMS_ARE_OUT_OF_STOCK" };
                    case 29:
                    ...
                    case 33:
                        cond = _b.sent();
                        if (!(cond == true)) return [3 /*break*/, 40];
                    ...
                    case 35:
                        _b.sent();
                        if (!selectedLinesData) return [3 /*break*/, 37];
                    ...
                    case 42: throw { status: 0, message: "INVALID_DATA" };
                    ...
                    case 45:
                        _b.sent();
                        throw error_3;
                    case 46: return [4 /*yield*/, queryRunner.release()];
                    case 47:
                        _b.sent();
                        return [7 /*endfinally*/];
