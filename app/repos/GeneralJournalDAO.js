...
var GeneralJournalDAO = /** @class */ (function () {
    ...
    GeneralJournalDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    GeneralJournalDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.GeneralJournalDAO = GeneralJournalDAO;
