        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        if (params.configId) {
                            query += " and  i.configid = '" + params.configId + "' ";
                        }
                        if (params.itemId) {
                            query += " and  i.itemid = '" + params.itemId + "' ";
                        }
                        ...
                        query += ") as i \n            group by i.name, i.nameAlias, i.wareHouseNameAr , \n           i.wareHouseNameEn , i.sizeNameEn, i.sizeNameAr ,\n           i.nameEn , i.nameAr , i.configId, i.itemid, i.inventsizeid, " + (params.batchno ? "i.batchno," : "") + "    i.transkind  order by i.itemid ";
